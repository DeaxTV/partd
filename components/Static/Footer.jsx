    ...
    return (
        router.pathname == "/" ? <div className="pt-10 sm:flex items-center justify-between">
            ...
            <div className="relative flex justify-end w-full sm:w-1/2">
                ...
                <h1 className="select-none heading-text absolute bottom-5 right-28 sm:right-5 text-3xl text-white font-bold text-center">&copy; {new Date().getFullYear()}, deax.</h1>
            </div>
        </div>
    );
};